...
> 版本：v2（「板块讨论度」模块已移除）｜更新：2026-08-06
...
- **中信期指卡片**（蓝框）：展示 IF/IC/IH/IM 各合约中信会员净多/净空，以及汇总净单（净多=红 / 净空=绿）。
...
```json
{
  ...
  "citic": { "date":"2026-08-06",
             "contracts": {"IF":{"label":"沪深300","net":...}, "IC":{...}, "IH":{...}, "IM":{...}},
             "total": {"long":156863,"short":238213,"net":-81350} },
